        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            {jobs.map((j) => (
                <tr
                  key={j.id}
                  onClick={() => { window.location.href = `/queue/${encodeURIComponent(j.id)}`; }}
                ...
                >
                  ...
                  <td style={td}>
                    {j.mode ? (
                      <span style={{
                        padding: "2px 6px", borderRadius: 999, fontSize: 10, fontWeight: 600, letterSpacing: 0.4,
                        background: j.mode === "exhaustive" ? "#1d1431" : "#0c1d35",
                        border: "1px solid " + (j.mode === "exhaustive" ? "#bc8cff" : "#58a6ff"),
                        color: j.mode === "exhaustive" ? "#bc8cff" : "#58a6ff",
